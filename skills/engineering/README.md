...
- [git-guardrails](./git-guardrails/SKILL.md) — Block dangerous git commands (push, reset --hard, clean, branch -D) on Claude Code and opencode
...
- [to-issues](./to-issues/SKILL.md) — Break a plan, spec, or PRD into independently-grabbable issues using vertical slices
...
- [zoom-out](./zoom-out/SKILL.md) — Get broader context or a higher-level perspective on a section of code
